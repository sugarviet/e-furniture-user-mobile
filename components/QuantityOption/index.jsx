...
const QuantityOption = ({ className, name, value, onPlus, onMinus }) => {
  ...
  return (
    <View
      className={classNames(
        className,
        "flex flex-row items-center bg-[#f3f3f3] rounded-[40px]"
      )}
    >
      <AntDesign
        onPress={onMinus}
        ...
        color="black"
      />
      <Text style={{ fontSize: text }} className="font-urbanistBold mx-4">
        {value}
      </Text>
      <AntDesign
        onPress={onPlus}
